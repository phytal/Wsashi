...
namespace Wsashi.Modules
{
    public class LeaveMessages : WsashiModule
    {
        ...
        [Remarks("w!leave channel <channel where welcome messages are> Ex: w!leave channel #general")]
        ...
        [Remarks("w!leave add <leave message> Ex: `leave add Oh noo! <usermention>, left <guildname>...`\n" +
        ...
        [Remarks("w!leave remove <leave message number (shown in w!leave list)> Ex: w!leave remove 1")]
