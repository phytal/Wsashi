...
namespace Wsashi.Modules.API.Anime.weebDotSh.NSFW
{
    public class AutoLewd : WsashiModule
    {
        [Command("autolewd")]
        [Summary("Loops images of lewd anime girls :3")]
        [Remarks("Usage: w!autolewd <on/off> Ex: w!autolewd on")]
        [Cooldown(5)]
        ...
        [Summary("Loops images of lewd anime girls :3")]
        [Remarks("Usage: w!autolewdchannel <channel you want images being sent to> Ex: w!autolewdchannel #nsfw")]
        [Cooldown(5)]
