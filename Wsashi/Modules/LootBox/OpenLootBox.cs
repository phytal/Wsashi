...
{
    public class OpenLootBox : WsashiModule
    {
        public static async Task OpenCommonBox(SocketUser user, ITextChannel channel)
        {
            ...
            int potatoes = Global.Rng.Next(70, 120);
            ...
            {
                int duelValue = Global.Rng.Next(1, 56);
        ...
        public static async Task OpenRareBox(SocketUser user, ITextChannel channel)
        {
            ...
            int potatoes = Global.Rng.Next(320, 500);
            config.Money += (ulong)potatoes;
            embed.AddField("Potatoes", potatoes);
            ...
            if (wasagotchiBool == 1 || wasagotchiBool == 2)
            {
                if (configg.Have != true)
                {
                    int wasagotchiValue = Global.Rng.Next(29, 64);
                    Tuple<string, string> wasagotchi = WasagotchiInteractive.GetWasagotchiRarity(wasagotchiValue);
                    embed.AddField("Wasagotchi", wasagotchi.Item2);
                    configg.Have = true;
                    configg.Breed = wasagotchi.Item1;
                ...
                else
                {
                    ...
                    embed.AddField("Wasagotchi Item", "Rare Wasagotchi Capsule (Open it with `w!openCapsule`!)");
                }
                GlobalWasagotchiUserAccounts.SaveAccounts();
            }
            int duelBool = Global.Rng.Next(1, 3);
        ...
        public static async Task OpenEpicBox(SocketUser user, ITextChannel channel)
        {
            ...
            int potatoes = Global.Rng.Next(550, 750);
            config.Money += (ulong)potatoes;
            embed.AddField("Potatoes", potatoes);
            ...
            if (wasagotchiBool == 1 || wasagotchiBool == 2)
            {
                if (configg.Have != true)
                {
                    int wasagotchiValue = Global.Rng.Next(48, 64);
                    Tuple<string, string> wasagotchi = WasagotchiInteractive.GetWasagotchiRarity(wasagotchiValue);
                    embed.AddField("Wasagotchi", wasagotchi.Item2);
                    configg.Have = true;
                    configg.Breed = wasagotchi.Item1;
                ...
                else
                {
                    ...
                    embed.AddField("Wasagotchi Item", "Epic Wasagotchi Capsule (Open it with `w!openCapsule`!)");
                }
                GlobalWasagotchiUserAccounts.SaveAccounts();
            }
            int duelBool = Global.Rng.Next(1, 3);
        ...
        public static async Task OpenLegendaryBox(SocketUser user, ITextChannel channel)
        {
            ...
            int potatoes = Global.Rng.Next(800, 1200);
            config.Money += (ulong)potatoes;
            embed.AddField("Potatoes", potatoes);
            ...
            if (wasagotchiBool == 1 || wasagotchiBool == 2)
            {
                if (configg.Have != true)
                {
                    int wasagotchiValue = Global.Rng.Next(63, 64);
                    Tuple<string, string> wasagotchi = WasagotchiInteractive.GetWasagotchiRarity(wasagotchiValue);
                    embed.AddField("Wasagotchi", wasagotchi.Item2);
                    configg.Have = true;
                    configg.Breed = wasagotchi.Item1;
                ...
                else
                {
                    ...
                    embed.AddField("Wasagotchi Item", "Legendary Wasagotchi Capsule (Open it with `w!openCapsule`!)");
                }
                GlobalWasagotchiUserAccounts.SaveAccounts();
            }
            int duelBool = Global.Rng.Next(1, 3);
